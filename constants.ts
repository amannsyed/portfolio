...
export const EXPERIENCES: Experience[] = [
  {
    ...
    achievements: [
      ...
      "Reduced manual transcript analysis time by 95% (20 hrs to under 5 min) by orchestrating a multi-agent NLP platform processing text, audio, and video inputs via Rev AI speech-to-text and 3-LLM consensus speaker extraction (Gemini/OpenAI/Claude).",
